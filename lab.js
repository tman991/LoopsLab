...
// } 
// else{console.log('Brittani and Amy have the same age')}
...
// // } 
// // else if (temperature < 80 && 60 >= temperature && rain === true){
...
// // } 
// // else if (temperature < 80 && 60 >= temperature && rain === false){
...
// /*
//   Create a while-loop that logs "Your score is not high enough" while the score variable above is below passingScore. In each iteration of the loop, increase 
...
let z = 5;
// Create a while loop that continues to run while z is greater than 0. Within the while loop, log a countdown from the value of z to 1. Once you have logged the countdown, make 
//sure you decrement z by 1. If your code is running properly, you should see: 5,4,3,2,1,4,3,2,1,3,2,1,2,1,1.
